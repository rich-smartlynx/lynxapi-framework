...
Framework to support "smartlinks"  (see [https://smartlinks.mobi/info.html ](https://smartlinks.mobi/info.html)for detils)

## Overview

Usage: initialize the libary with the apiKey you were given  lynxapi = Lynx(apiKey: )  
